...
*گره‌های منحنی H/V* (افقی/عمودی یا horizontal/vertical) گونه‌ای از نقاط منحنی هستند که به محور افقی یا عمومی می‌چسبند
&mdash;
...
در فهرست Point، خواهید دید که گزینهٔ گره *گوشه یا Corner* تیک خورده است.
